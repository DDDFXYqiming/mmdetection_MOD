...
annotation_file = "./mmdetection/data/coco/annotations/instances_val2017.json"
with open(annotation_file, "r") as f:
    data = json.load(f)

# image_folder = "./mmdetection/data/coco/train2017"
image_folder = "./mmdetection/data/coco/val2017"
